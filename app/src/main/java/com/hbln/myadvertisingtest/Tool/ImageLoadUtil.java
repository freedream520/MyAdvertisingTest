package com.hbln.myadvertisingtest.Tool;
...
import com.hbln.myadvertisingtest.R;
...
public class ImageLoadUtil {
    ...
    private ImageLoadUtil() {
        imageOptions = new ImageOptions.Builder().setImageScaleType(ImageView.ScaleType.CENTER_INSIDE).setLoadingDrawableId(R.mipmap.ic_launcher).setFailureDrawableId(R.mipmap.ic_launcher).build();
    }
    ...
    public void display(String url, ImageView imageView) {
        ...
        //x.image().bind(iv_big_img, "file:/sdcard/test.gif", imageOptions);
        if (!url.contains(NetConstants.HOST)) {
            url = NetConstants.HOST + url;
        }
